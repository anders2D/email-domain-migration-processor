...
echo "1. File to CSV"
python main_cli.py --input-type file --input examples/file_examples/sample_emails.txt --new-domain company.com --output-type csv --output output_file_csv.csv
echo

echo "2. File to JSON"
python main_cli.py --input-type file --input examples/file_examples/sample_emails.txt --new-domain company.com --output-type json --output output_file_json.json
echo

echo "3. File to Inline"
python main_cli.py --input-type file --input examples/file_examples/sample_emails.txt --new-domain company.com --output-type inline
echo

echo "4. File to Silent"
python main_cli.py --input-type file --input examples/file_examples/sample_emails.txt --new-domain company.com --output-type silent
echo
