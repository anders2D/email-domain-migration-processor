...
REM
REM OPCION 1 (Recomendado): Instalar desde PyPI
REM   pip install email-processor-cli
REM   Luego usa: email-processor [opciones]
REM
REM OPCION 2: Usar código fuente
REM   python main_cli.py [opciones]
...
echo 1. File to CSV
email-processor --input-type file --input file_examples\sample_emails.txt --new-domain company.com --output-type csv --output output_file_csv.csv
echo.

echo 2. File to JSON
email-processor --input-type file --input file_examples\sample_emails.txt --new-domain company.com --output-type json --output output_file_json.json
echo.

echo 3. File to Inline
email-processor --input-type file --input file_examples\sample_emails.txt --new-domain company.com --output-type inline
echo.

echo 4. File to Silent
email-processor --input-type file --input file_examples\sample_emails.txt --new-domain company.com --output-type silent
echo.
